...
export default function ExpenseTracker() {
  ...
  const catData = CATEGORIES.map((c) => ({
    name: c,
    need: expenses
      .filter((e) => e.category === c && e.type === "need")
      .reduce((s, e) => s + e.amount, 0),
    want: expenses
      .filter((e) => e.category === c && e.type === "want")
      .reduce((s, e) => s + e.amount, 0),
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              padding: "9px 20px",
              background: saving ? C.goldDim : C.gold,
              color: "#0D0F14",
              border: "none",
              borderRadius: 8,
              fontWeight: 700,
            ...
            {filtered.length === 0 ? (
              ...
              filtered.map((e) => (
                ...
                >
                  ...
                  <Pill color={e.type === "need" ? C.green : C.gold}>
                    {e.type}
                  </Pill>
                  <div
                    style={{
